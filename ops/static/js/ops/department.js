...
jQuery(function($) {
    ...
    jQuery(department_grid).jqGrid({
        ...
        //data: 'json',
        //mtype: 'POST',
        url: '/users/department?type=load',
        datatype: "json",
        height: 'auto',
        colNames:['ID','部门名称','英文名称','上级部门','创建时间','修改时间',' '],
        colModel:[
            ...
            {name:'parent',index:'parent', width:110,editable: true,edittype:"select",editoptions:{value:getDepartment}},
        ...
        editurl: '/users/department/',//nothing is saved 注意结尾/ , APPEND_SLASH
        caption: "部门管理",
        autowidth: true,
    ...
    //navButtons
    jQuery(department_grid).jqGrid('navGrid',department_pager,
        { 	//navbar options
            edit: true,
    ...
    //jQuery(department_grid).jqGrid('filterToolbar',{defaultSearch:true,stringResult:true})
...
function gridReload(){
    ...
    jQuery(department_grid).jqGrid('setGridParam', {
        url : "/users/department/?type=search&search_enname=" + search_enname+"&search_cnname="+search_cnname,
        page : 1
    }).trigger("reloadGrid");
}
